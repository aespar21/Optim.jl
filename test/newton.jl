let
    ...
    @test_throws ArgumentError Optim.optimize(Differentiable(f_1, g!_1, [0.0]), [0.0], Newton())
    Optim.optimize(Differentiable(f_1, g!_1, [0.0]), [0.0], Newton(), Optim.Options(autodiff = true))
