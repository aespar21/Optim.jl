...
function levenberg_marquardt{F<:Function, G<:Function, T}(f::F, g::G, initial_x::AbstractVector{T};
    ...
    MultivariateOptimizationResults("Levenberg-Marquardt", initial_x, x, sumabs2(fcur), iterCt, !converged, x_converged, 0.0, false, 0.0, g_converged, tolG, false, tr, (false, false, false), f_calls, g_calls, 0)
end
